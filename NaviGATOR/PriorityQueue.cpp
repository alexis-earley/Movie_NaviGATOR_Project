...
UnorderedMap::UnorderedMap(int setCapacity)
...
int UnorderedMap::genHash(string id)
{ //generates hash code
...
void UnorderedMap::insert(string id, Movie *newMovie)
{
...
Movie *UnorderedMap::find(string id)
{
...
void UnorderedMap::remove(string id)
{
    int bucketIndex = genHash(id);
    string currID;
    int i;
...
void UnorderedMap::rehashMap(int newCapacity)
