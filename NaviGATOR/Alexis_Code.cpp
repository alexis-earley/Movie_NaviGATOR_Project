...
public:
    ...
    void buildMinQueue()
    {
        ...
        if (inFile.is_open())
        {
            ...
            cout << "It took: " << resultTime << " seconds to parse through the first file, inserting data into the heap 85855 times." << endl;
        }
        inFile.close();
        ...
        if (inFile.is_open())
        {
            ...
            cout << "It took: " << resultTime << " seconds to parse through the second file, searching for data in the heap 85855 times." << endl;
            cout << endl;
        }
...
int main()
{
    ...
    while (n != 12)
    {
        ...
        cout << "10. Enter preferred minimum and maximum year" << endl;
